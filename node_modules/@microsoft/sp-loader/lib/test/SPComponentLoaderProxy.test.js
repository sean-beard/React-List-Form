...
var TestManifests_1 = require("./data/TestManifests");
    ...
    describe('SPComponentLoaderProxy is initialized', function () {
        ...
        describe('loadComponent(IClientSideComponentManifest)', function () {
            it('loadComponent(IClientSideComponentManifest) calls real instance', function () {
                ...
                SPComponentLoaderProxy_1.default.loadComponent(manifest);
                chai_1.assert.isTrue(loadComponentSpy.calledOnce);
                chai_1.assert.isTrue(loadComponentSpy.calledWithExactly(manifest));
        ...
        describe('registerManifests(IClientSideComponentManifest)', function () {
            it('registerManifests(IClientSideComponentManifest) calls real instance', function () {
                ...
                SPComponentLoaderProxy_1.default.registerManifests([manifest]);
                chai_1.assert.isTrue(registerManifestsSpy.calledOnce);
                chai_1.assert.isTrue(registerManifestsSpy.calledWithExactly([manifest]));
        ...
        describe('getManifestById(string, string?)', function () {
            ...
            beforeEach(function () {
                getManifestByIdSpy = sinon.spy(componentLoaderImpl, 'tryGetManifestById');
            });
            afterEach(function () {
            ...
            it('getManifestById(string) calls real instance', function () {
                ...
                SPComponentLoaderProxy_1.default.tryGetManifestById(id);
            ...
            it('getManifestById(string, string) calls real instance', function () {
                ...
                var version = 'thisIsAVersion';
                getManifestByIdSpy.reset();
                SPComponentLoaderProxy_1.default.tryGetManifestById(id, version);
                chai_1.assert.isTrue(getManifestByIdSpy.calledOnce);
        ...
        describe('start()', function () {
            it('start() calls real instance', function () {
                var startSpy = sinon.spy(componentLoaderImpl, 'startApplication');
                var applicationId = 'thisIsAnApplicationId';
                var applicationData = {
                    clientSideApplicationId: test_api_1.TEST_UNDEFINED,
                    manifests: test_api_1.TEST_UNDEFINED,
                    spPageContextInfo: test_api_1.TEST_UNDEFINED
                };
                SPComponentLoaderProxy_1.default.startApplication(applicationId, applicationData);
                chai_1.assert.isTrue(startSpy.calledOnce);
                chai_1.assert.isTrue(startSpy.calledWithExactly(applicationId, applicationData));
                startSpy.restore();
            });
        });
    });
