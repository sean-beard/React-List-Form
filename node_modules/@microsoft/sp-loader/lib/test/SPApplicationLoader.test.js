...
describe('SPApplicationLoader tests', function () {
    describe('loadApplication()', function () {
        ...
        it('fails if application manifest is not registered', function (done) {
            ...
            SPApplicationLoader_1.default.startApplication(applicationId, preloadedData).catch(function (error) {
                done();
            });
        });
        ...
        it('fails if platform fails to load', function (done) {
            ...
            SPApplicationLoader_1.default.startApplication(applicationId, fullPreloadedData).catch(function (error) {
        ...
        it('fails if application fails to load', function (done) {
            ...
            SPApplicationLoader_1.default.startApplication(applicationId, fullPreloadedData)
                .then(function (app) {
                chai_1.assert.fail();
                done();
            })
