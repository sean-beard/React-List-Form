...
/**
 * A map to maintain the state(collapsed or not) of all the groups of a PropertyPane page.
 * This dictionary is updated when the user makes any changes to the PropertyPane group.
 */
export declare type PropertyPaneGroupsStateMap = {
    [key: string]: boolean;
};
/**
 * A map to maintain the PropertyPaneGroupsState for the PropertyPane pages.
 */
export declare type PropertyPanePagesStateMap = {
    [key: string]: PropertyPaneGroupsStateMap;
};
/**
...
export default class PropertyPane extends React.Component<IPropertyPaneProps, IPropertyPaneState> {
    ...
    /**
     * Dictionary to maintain the PropertyPaneGroupsState for each PropertyPane page.
     *
     * @private
     * @type PropertyPanePagesStateMap
     * @memberOf PropertyPane
     */
    private _propertyPanePagesStateMap;
    /**
     ...
     */
    private _propertyPaneGroupStateChanged(pageNumber, groupName, isCollapsed);
    /**
     * Returns if the empty page should be rendered in property pane.
     */
    private readonly _shouldRenderEmptyPage;
    /**
     ...
     * @private
     */
    private _propertyPaneShouldLooseFocus();
    private _setTimeOutForFocus();
    private readonly _isManagingFocusBySettings;
    ...
    private _getCssBottomValueForPageContentElement();
}
