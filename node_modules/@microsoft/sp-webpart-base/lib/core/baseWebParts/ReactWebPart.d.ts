 ...
 * @internal
 */
declare abstract class ReactWebPart<TProperties> extends BaseClientSideWebPart<TProperties> {
    private _componentType;
    private _componentInstance;
    constructor(componentType: React.ComponentClass<IReactWebPartProps>);
    render(): void;
