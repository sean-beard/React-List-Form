 ...
 * @public
 */
declare abstract class BaseClientSideWebPart<TProperties> extends BaseComponent {
    /**
    ...
    /**
     * Calculates minimum height required for the webpart to render with current width
     ...
     *
     * @param shouldRerender - Indicating whether web part needs to be re-rendered or not.
     */
    private _afterPropertyUpdated(shouldRerender);
    /**
