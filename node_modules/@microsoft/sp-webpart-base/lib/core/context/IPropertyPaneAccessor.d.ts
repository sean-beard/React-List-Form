...
export interface IPropertyPaneAccessor {
    ...
    refresh(): void;
    /**
     * Indicates whether the PropertyPane was initially opened by the web part.  For example, if the
     * web part calls this.context.propertyPane.open() then the property would be true, whereas if
