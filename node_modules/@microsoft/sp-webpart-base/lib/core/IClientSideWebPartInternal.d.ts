...
export interface IClientSideWebPartInternal extends IPropertyPaneControl, IViewportAwareWebPart {
    ...
    _initializeContext(context: WebPartContext): void;
    _internalInitialize(webPartContext: WebPartContext): void;
    ...
    _internalSetWebPartData(newWebPartData: IWebPartData): void;
