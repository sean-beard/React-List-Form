 ...
 */
export declare class ResourceMap implements IDisposable {
    private _handles;
    /**
     ...
     * @returns the resource instance
     */
    expose<T>(key: IResourceKey, instance: T, type: ResourceType): T;
    dispose(): void;
}
declare const _default: ResourceMap;
