...
var WebpackTask = (function (_super) {
    ...
    function WebpackTask(extendedName, extendedConfig) {
        return _super.call(this, extendedName || 'webpack', __assign({ configPath: './webpack.config.js', suppressWarnings: [] }, extendedConfig) // tslint:disable-line:no-any
        ) || this;
    }
            ...
            if (webpackConfig) {
                ...
                webpack(webpackConfig, function (error, stats) {
                    ...
                    if (statsResult.warnings && statsResult.warnings.length) {
                        ...
                        var warningSuppressionRegexes_1 = (_this.taskConfig.suppressWarnings || []).map(function (regex) {
                            return new RegExp(regex);
                        });
                        statsResult.warnings.forEach(function (warning) {
                            var suppressed = false;
                            for (var i = 0; i < warningSuppressionRegexes_1.length; i++) {
                                var suppressionRegex = warningSuppressionRegexes_1[i];
