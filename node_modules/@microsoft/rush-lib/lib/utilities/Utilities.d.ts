...
export default class Utilities {
     ...
     * @alpha
     */
    static executeShellCommand(command: string, workingDirectory: string, environmentVariables?: {
        [key: string]: string;
    }, captureOutput?: boolean): child_process.SpawnSyncReturns<Buffer>;
    /**
     * Executes the command using cmd if running on windows, or using sh if running on a non-windows OS.
     * @param command - the command to run on shell
     * @param workingDirectory - working directory for running this command
     ...
     * @alpha
     */
    static executeShellCommandAsync(command: string, workingDirectory: string, environmentVariables?: {
        [key: string]: string;
    }, captureOutput?: boolean): child_process.ChildProcess;
    /**
