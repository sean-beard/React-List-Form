webpackJsonp8be81a5c_af38_4bb2_af97_afa3b64dfbed_1_2_0([3],{
...
c){for(var e=0,f=this.rules,k=f.length,d;c&&e<k;e++)d=f[e],a.nonEditable&&!d.options.applyToAll||a.nestedEditable&&d.options.excludeNestedEditable||(c=c.replace(d.value[0],d.value[1]));return c}}}(),function(){function a(a,d){function g(a){return a||CKEDITOR.env.needsNbspFiller?new CKEDITOR.htmlParser.text(" "):new CKEDITOR.htmlParser.element("br",{"data-cke-bogus":1})}function f(a,d){return function(e){if(e.type!=CKEDITOR.NODE_DOCUMENT_FRAGMENT){var f=[],q=b(e),m,k;if(q)for(h(q,1)&&f.push(q);q;)l(q)&&
...
CKEDITOR.plugins.add("contextmenu",{}),function(){function a(a,b){function k(b){b=g.list[b];var c;b.equals(a.editable())||"true"==b.getAttribute("contenteditable")?(c=a.createRange(),c.selectNodeContents(b),c=c.select()):(c=a.getSelection(),c.selectElement(b));CKEDITOR.env.ie&&a.fire("selectionChange",
...
n.getName()||(n=a[p].parent.clone(!1,1),f&&n.setAttribute("dir",f),l.append(n));r=n.append(H.element.clone(0,1));G!=n.getDirection(1)&&r.setAttribute("dir",G);for(h=0;h<H.contents.length;h++)r.append(H.contents[h].clone(1,1));p++}else if(H.indent==Math.max(C,0)+1)H=a[p-1].element.getDirection(1),p=CKEDITOR.plugins.list.arrayToList(a,null,p,e,H!=G?G:null),!r.getChildCount()&&CKEDITOR.env.needsNbspFiller&&7>=k.$.documentMode&&r.append(k.createText(" ")),r.append(p.listNode),p=p.nextIndex;else if(-1==
...
F=CKEDITOR.env,J=CKEDITOR.env.ie&&9>CKEDITOR.env.version,H=CKEDITOR.dtd,M={},L=128,D=64,T=32,I=16,O=4,K=2,U=1,V=" ",ca=H.$listItem,fa=H.$tableContent,P=C({},H.$nonEditable,H.$empty),Q=H.$block,N=100,S="width:0px;height:0px;padding:0px;margin:0px;display:block;z-index:9999;color:#fff;position:absolute;font-size: 0px;line-height:0px;",R=S+"border-color:transparent;display:block;border-style:solid;",Y="\x3cspan\x3e"+V+"\x3c/span\x3e";M[CKEDITOR.ENTER_BR]="br";M[CKEDITOR.ENTER_P]="p";M[CKEDITOR.ENTER_DIV]=
...
//# sourceMappingURL=3.sp-canvas-ckeditor4.7_57a5f749fee82159bb97.js.map