...
export default class MobilePreview extends React.Component<IMobilePreviewProps, IMobilePreviewState> {
    ...
    private _onClickstopChangeForm(device);
    private _onClickRotate(orientation);
    private _onClickChangeDeviceType(type);
    private _onChangedX(event);
    private _onChangedY(event);
    private _onChangedURLField(value);
    private _onClickURL();
    ...
    private _comparePhones(deviceA, deviceB);
    private _compareTablets(deviceA, deviceB);
}
