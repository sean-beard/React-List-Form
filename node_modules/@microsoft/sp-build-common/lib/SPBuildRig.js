...
var SPBuildRig = (function (_super) {
    ...
    function SPBuildRig() {
        ...
        _this._preBuildTasks = [];
        _this._postTypescriptTasks = [];
        _this._postBuildTasks = [];
        return _this;
    }
    ...
    SPBuildRig.prototype.getCoreBuildTask = function () {
        return coreBuild.parallel(gulp_core_build_typescript_1.tslint, coreBuild.serial(coreBuild.serial(gulp_core_build_typescript_1.typescript, gulp_core_build_typescript_1.removeTripleSlash, gulp_core_build_typescript_1.apiExtractor), coreBuild.serial.apply(coreBuild, this._postTypescriptTasks)));
    };
