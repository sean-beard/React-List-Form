 ...
 * @beta
 */
export interface IClientSideComponentLoaderConfiguration {
    /**
    ...
    exportName?: string;
    /**
     * Definition: This is a dictionary of named script resources. "path" and "localizedPath" modules may reference each
...
export interface IModuleConfiguration {
    /**
     * Definition: The type of the script block. "component" modules come from a component,
     *  "path" and "localizedPath" modules must be available on the paths provided in the "internalModuleBaseUrls" field.
     *  Modules with the "path" type use the "IPathModuleConfiguration" interface. Modules with the "component" type use
     *  the "IComponentModuleConfiguration" interface. Modules with the "localizedPath" type use the
...
export interface IComponentModuleConfiguration extends IModuleConfiguration {
    /**
     * Definition: The version of the framework-supplied component to be loaded. For framework runtime component such as
    ...
    version: string;
    /**
     * Definition: The ID of the framework-supplied component to be loaded.
     * Required: yes
     * Localized: no
    ...
    id: string;
    /**
     * Definition: A path to the framework-supplied component in case the framework fails to load the requested version.
...
/**
 * This is the interface for a script module with the "localizedPath" type. Modules of this type must be provided by the
 *  component developer. These script resources are similar to those of the "path" type, but they may be present
