...
describe('Manifest schema validator', function () {
    ...
    exampleManifestFiles.forEach(function (manifestFile) {
        ...
        else if (schemaFileBasename.match(/commandset/i)) {
            validationFn = manifestSchemaValidator_1.default.validateCommandSetManifest;
        }
        else if (schemaFileBasename.match(/extension/i)) {
            validationFn = manifestSchemaValidator_1.default.validateExtensionManifest;
        }
        ...
        else if (schemaFileBasename.match(/assembly/i)) {
            validationFn = manifestSchemaValidator_1.default.validateAssemblyManifest;
        }
        else {
