                ...
                fs.readdirSync(distPath).forEach(function (distFilename) {
                    if (distFilename.match(manifestFileRegExp_1)) {
                        try {
                            ...
                            var manifestData = lodash_1.cloneDeep(gulp_core_build_1.SchemaValidator.readCommentedJsonFile(distFilePath));
        ...
        if (linkedProjectManifests) {
            ...
            if (!isSinglePackage && linkedProjectManifests.length === 2) {
                if (linkedProjectManifests[0].id === linkedProjectManifests[1].rootComponentId ||
                    ...
                    var assemblyId = linkedProjectManifests[1].rootComponentId
