...
function getRequiresCustomScriptProperty(manifest) {
    ...
    var requiresCustomScript = !!manifest.requiresCustomScript;
...
function createExtensionComponent(manifest) {
    var requiresCustomScript = getRequiresCustomScriptProperty(manifest);
    return {
        name: manifest.alias,
        description: manifest.extensionType + " - " + manifest.alias,
        id: manifest.id,
        manifest: manifest,
        requiresCustomScript: requiresCustomScript,
        componentDefinition: {}
    };
}
