...
var CollectLocalizedResourcesTask = (function (_super) {
    ...
    function CollectLocalizedResourcesTask() {
        return _super.call(this, 'collectLocalizedResources', {}) || this;
    }
    CollectLocalizedResourcesTask.prototype.executeTask = function (gulp, completeCallback) {
        ...
        var promises = localizedResourceKeys.map(function (key) {
            return _this._collectResourcesForKey(localizedResources[key])
    ...
    CollectLocalizedResourcesTask.prototype._collectResourcesForKey = function (rawPattern) {
        var _this = this;
        ...
        return new Promise(function (resolve, reject) {
            if (!pattern.match(CollectLocalizedResourcesTask._localeTokenRegExp)) {
                ...
                var fullPath_1 = path.join(_this.buildConfig.rootPath, pattern);
                ...
                glob(globPattern, { cwd: _this.buildConfig.rootPath }, function (error, files) {
                    if (error) {
                        reject(error.message);
                    }
                    else if (!files || files.length === 0) {
                        reject("No localized files found under the root directory (\"" + _this.buildConfig.rootPath + "\") matching " +
                            ("pattern \"" + rawPattern + "\""));
                    }
                    else {
                        ...
                        files.forEach(function (file) {
                            ...
                            if (!match) {
                                ...
                                result_1[locale] = path.join(_this.buildConfig.rootPath, file);
                            }
                        });
                        resolve(result_1);
                    }
