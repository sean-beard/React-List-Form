 ...
 */
export declare class CasperJSTask extends GulpTask<void> {
    constructor();
    executeTask(gulp: typeof Gulp, completeCallback: (result?: string) => void): NodeJS.ReadWriteStream;
    private _createCasperJSErrorMessage(errors);
    private _getFiles(dir);
    private _startCasperTestOnChildProcess(cmd);
    private _getRandomPortNumber();
}
