...
var CopyStaticAssetsTask = (function (_super) {
    ...
    function CopyStaticAssetsTask() {
        return _super.call(this, 'copy-static-assets', {
            includeExtensions: [],
            excludeExtensions: [],
            includeFiles: [],
            excludeFiles: []
    ...
    CopyStaticAssetsTask.prototype.executeTask = function (gulp, completeCallback) {
        ...
        var globPatterns = [];
        var allExtensions = this.taskConfig.includeExtensions.concat(ConfigureWebpackTask_1.fileLoaderExts, ['json', 'html', 'css']);
