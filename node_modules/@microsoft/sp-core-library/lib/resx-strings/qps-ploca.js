define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      ...
      "invalidVersionStringError": "***Ĩŉváĺįđ věŕšīŏń śţŗįňġ: \"{0}\"",
      ...
      "serviceScopeAlreadyFinishedError": "***Ťħē ŞęŕvįčėŠčōƿē īş āłŕęȃďŷ ƒĩŉĭśĥēď",
      "serviceScopeProvideServiceAfterFinishedError": "***Ĉȁŋŉŏŧ ŕěğįşţēř šěŗvīĉē ƃȅćâūśē ţĥĕ ŝčơƥȇ īŝ āĺřēȁďƴ ƒıňıŝħȅđ",
