...
var configResources = build.karma.resources; // tslint:disable-line:no-any
...
var spPolyfillsPath = path.join(spPolyfillsRoot, 'lib', 'index.js');
var webpackConfig = build.configureWebpack.getKarmaConfig((debugMode ? [] : [
    {
        test: /\.js$/,
        exclude: /(test|node_modules|bower_components|systemjs|requirejs)/,
