...
var SassTask = (function (_super) {
    ...
    function SassTask() {
        var _this = _super.call(this, 'sass', {
                ...
                if (classNames) {
                    ...
                    classKeys_1.forEach(function (key, index) {
                        ...
                        if (key.indexOf('-') !== -1) {
                            ...
                            _this.taskConfig.warnOnCssInvalidPropertyName ?
                                _this.logWarning(message) :
                                _this.logVerbose(message);
                            line = "  '" + key + "': '" + value + "'";
                        }
                        else {
                            line = "  " + key + ": '" + value + "'";
                    ...
                    if (_this.taskConfig.moduleExportName === '') {
                        exportString = 'export = styles;';
                    }
                    else if (!!_this.taskConfig.moduleExportName) {
                        exportString = "export const " + _this.taskConfig.moduleExportName + " = styles;";
                    }
