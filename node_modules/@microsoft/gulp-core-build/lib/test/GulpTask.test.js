...
var mockBuildConfig_1 = require("./mockBuildConfig");
var testArray = [];
...
var SyncTask = (function (_super) {
    ...
    function SyncTask() {
        return _super.call(this, 'sync', {}) || this;
    }
...
var SyncWithReturnTask = (function (_super) {
    ...
    function SyncWithReturnTask() {
        return _super.call(this, 'sync-with-return', {}) || this;
    }
...
var CallbackTask = (function (_super) {
    ...
    function CallbackTask() {
        return _super.call(this, 'schema-task', {}) || this;
    }
...
var SchemaTask = (function (_super) {
    ...
    function SchemaTask() {
        var _this = _super.call(this, 'schema-task', {
...
describe('GulpTask', function () {
    var _loop_1 = function (task) {
        it(task.name + " serial", function (done) {
            ...
            index_1.serial(task).execute(mockBuildConfig_1.mockBuildConfig).then(function () {
        ...
        it(task.name + " parallel", function (done) {
            testArray = [];
            task.setConfig({ addToMe: testArray });
            index_1.parallel(task).execute(mockBuildConfig_1.mockBuildConfig).then(function () {
                chai_1.expect(testArray).to.deep.equal([task.name]);
                done();
            }).catch(done);
        });
    ...
    it("all tasks serial", function (done) {
        ...
        index_1.serial(tasks).execute(mockBuildConfig_1.mockBuildConfig).then(function () {
    ...
    it("all tasks parallel", function (done) {
        ...
        index_1.parallel(tasks).execute(mockBuildConfig_1.mockBuildConfig).then(function () {
