...
/** @public */
export declare function generateGulpError(err: Object): Object;
/**
 * Logs an error to standard error and causes the build to fail.
 ...
 * @public
 */
export declare function initialize(gulp: typeof Gulp, gulpErrorCallback?: (err: Error) => void, gulpStopCallback?: (err: Error) => void): void;
/**
 * @public
 */
