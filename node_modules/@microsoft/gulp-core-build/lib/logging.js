    ...
    if (!localCache.writingSummary) {
        ...
        afterStreamsFlushed(function () {
            ...
            afterStreamsFlushed(function () {
                ...
                var name = state.builtPackage.name || 'with unknown name';
                var version = state.builtPackage.version || 'unknown';
...
function warn() {
    ...
    var stringMessage = normalizeMessage(args.join(' '));
...
function messageIsSuppressed(message) {
    for (var _i = 0, _a = localCache.errorAndWarningSuppressions; _i < _a.length; _i++) {
        var suppression = _a[_i];
