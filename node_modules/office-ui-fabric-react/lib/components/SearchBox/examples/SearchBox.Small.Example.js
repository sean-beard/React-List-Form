...
var SearchBoxSmallExample = (function (_super) {
    ...
    SearchBoxSmallExample.prototype.render = function () {
        return (React.createElement("div", { className: 'ms-SearchBoxSmallExample' },
            React.createElement(SearchBox_1.SearchBox, { onChange: function (newValue) { return console.log('SearchBox onChange fired: ' + newValue); }, onSearch: function (newValue) { return console.log('SearchBox onSearch fired: ' + newValue); }, onFocus: function () { return console.log('onFocus called'); }, onBlur: function () { return console.log('onBlur called'); } })));
    };
