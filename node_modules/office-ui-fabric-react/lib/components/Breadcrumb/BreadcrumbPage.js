...
var BreadcrumbPage = (function (_super) {
    tslib_1.__extends(BreadcrumbPage, _super);
    function BreadcrumbPage() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BreadcrumbPage.prototype.render = function () {
        return (React.createElement(example_app_base_1.ComponentPage, { title: 'Breadcrumb', componentName: 'BreadcrumbExample', exampleCards: React.createElement("div", null,
                React.createElement(example_app_base_1.ExampleCard, { title: 'Simple breadcrumb', code: BreadcrumbBasicExampleCode },
                    React.createElement(Breadcrumb_Basic_Example_1.BreadcrumbBasicExample, null)),
                React.createElement(example_app_base_1.ExampleCard, { title: 'Static width', code: BreadcrumbStaticExampleCode },
                    React.createElement(Breadcrumb_Static_Example_1.BreadcrumbStaticExample, null))), propertiesTables: React.createElement(example_app_base_1.PropertiesTableSet, { sources: [
