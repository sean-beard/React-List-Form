...
var _items;
var HoverCardField = (function (_super) {
    ...
    HoverCardField.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { ref: function (c) { return !_this.state.contentRendered && _this.setState({ contentRendered: c }); } },
            this.props.content,
            this.state.contentRendered &&
                React.createElement(HoverCard_1.HoverCard, { expandingCardProps: this.props.expandingCardProps, instantOpenOnClick: true, target: this.state.contentRendered })));
    };
    return HoverCardField;
}(Utilities_1.BaseComponent));
var HoverCardTargetExample = (function (_super) {
    ...
    HoverCardTargetExample.prototype._onRenderItemColumn = function (item, index, column) {
        ...
        if (column.key === 'location') {
            return (React.createElement("div", { className: 'HoverCard-item' },
                React.createElement(HoverCardField, { content: item.location, expandingCardProps: expandingCardProps })));
        }
