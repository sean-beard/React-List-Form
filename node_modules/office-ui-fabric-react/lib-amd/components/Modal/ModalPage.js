define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "office-ui-fabric-react/lib/Link", "./examples/Modal.Basic.Example"], function (require, exports, tslib_1, React, example_app_base_1, Link_1, Modal_Basic_Example_1) {
    "use strict";
    ...
    var ModalPage = (function (_super) {
        tslib_1.__extends(ModalPage, _super);
        function ModalPage() {
        ...
        ModalPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'Modal', componentName: 'ModalExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement("p", null,
                        ...
                        React.createElement(Link_1.Link, { href: '#/components/dialog' }, "Dialog"),
