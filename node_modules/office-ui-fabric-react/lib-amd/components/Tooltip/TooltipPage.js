define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/Layer", "@uifabric/example-app-base", "./examples/Tooltip.Custom.Example", "./examples/Tooltip.Basic.Example", "./examples/Tooltip.Overflow.Example", "./TooltipPage.scss"], function (require, exports, tslib_1, React, Link_1, Layer_1, example_app_base_1, Tooltip_Custom_Example_1, Tooltip_Basic_Example_1, Tooltip_Overflow_Example_1) {
    "use strict";
    ...
    var TooltipPage = (function (_super) {
        ...
        TooltipPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'Tooltip', componentName: 'TooltipExample', exampleCards: React.createElement(Layer_1.LayerHost, null,
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Tooltip', code: TooltipBasicExampleCode },
                        React.createElement(Tooltip_Basic_Example_1.TooltipBasicExample, null)),
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Custom Tooltip', code: TooltipCustomExampleCode },
