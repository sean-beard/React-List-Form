define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "office-ui-fabric-react/lib/Checkbox", "./examples/Button.Default.Example", "./examples/Button.ContextualMenu.Example", "./examples/Button.Primary.Example", "./examples/Button.Compound.Example", "./examples/Button.Command.Example", "./examples/Button.Icon.Example", "./examples/Button.Anchor.Example", "./examples/Button.ScreenReader.Example", "./examples/Button.Swap.Example", "./examples/Button.Split.Example", "../../Link", "./examples/Button.Basic.Example.scss"], function (require, exports, tslib_1, React, example_app_base_1, Checkbox_1, Button_Default_Example_1, Button_ContextualMenu_Example_1, Button_Primary_Example_1, Button_Compound_Example_1, Button_Command_Example_1, Button_Icon_Example_1, Button_Anchor_Example_1, Button_ScreenReader_Example_1, Button_Swap_Example_1, Button_Split_Example_1, Link_1) {
    "use strict";
    ...
    var ButtonSplitCustomExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Button/examples/Button.Split.Example.tsx');
    var ButtonPage = (function (_super) {
        ...
        ButtonPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'Button', componentName: 'ButtonExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(Checkbox_1.Checkbox, { label: 'Mark as checked', checked: this.state.areButtonsChecked, onChange: this._onToggledChanged.bind(this) }),
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Primary Button', code: ButtonPrimaryExampleCode },
                        React.createElement(Button_Primary_Example_1.ButtonPrimaryExample, { disabled: this.state.areButtonsDisabled, checked: this.state.areButtonsChecked })),
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Command Button', code: ButtonCommandExampleCode },
                        React.createElement(Button_Command_Example_1.ButtonCommandExample, { disabled: this.state.areButtonsDisabled, checked: this.state.areButtonsChecked })),
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: 'SplitButton', code: ButtonSplitExampleCode },
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: '', code: ButtonSplitExampleCode },
