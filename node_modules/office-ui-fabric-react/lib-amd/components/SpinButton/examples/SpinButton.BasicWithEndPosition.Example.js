define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/SpinButton", "office-ui-fabric-react/lib/utilities/positioning"], function (require, exports, tslib_1, React, SpinButton_1, positioning_1) {
    ...
    var SpinButtonBasicWithEndPositionExample = (function (_super) {
        ...
        SpinButtonBasicWithEndPositionExample.prototype.render = function () {
            return (React.createElement("div", { style: { width: '400px' } },
                React.createElement(SpinButton_1.SpinButton, { defaultValue: '0', iconProps: { iconName: 'Light' }, label: 'Basic SpinButton', labelPosition: positioning_1.Position.end, min: 0, max: 100, step: 1, onFocus: function () { return console.log('onFocus called'); }, onBlur: function () { return console.log('onBlur called'); } })));
        };
