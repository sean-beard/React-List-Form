define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./examples/Dialog.Basic.Example", "./examples/Dialog.LargeHeader.Example", "./examples/Dialog.Blocking.Example"], function (require, exports, tslib_1, React, example_app_base_1, Dialog_Basic_Example_1, Dialog_LargeHeader_Example_1, Dialog_Blocking_Example_1) {
    "use strict";
    ...
    var DialogPage = (function (_super) {
        tslib_1.__extends(DialogPage, _super);
        function DialogPage() {
