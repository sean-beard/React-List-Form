define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/DocumentCard", "office-ui-fabric-react/lib/Image", "office-ui-fabric-react/lib/Persona", "office-ui-fabric-react/lib/Checkbox", "office-ui-fabric-react/lib/Pickers", "../../../common/TestImages", "./Picker.CustomResult.Example.scss"], function (require, exports, tslib_1, React, DocumentCard_1, Image_1, Persona_1, Checkbox_1, Pickers_1, TestImages_1) {
    ...
    exports.SuggestedBigItem = function (documentProps, itemProps) {
        ...
        return (React.createElement(Persona_1.Persona, { imageUrl: documentPreviewProps && documentPreviewProps.previewImages[0].previewImageSrc, primaryText: documentTitleProps && documentTitleProps.title, size: Persona_1.PersonaSize.small }));
    };
    exports.SelectedDocumentItem = function (documentProps) {
        ...
        if (documentActionsProps) {
            ...
            actions.push({
                icon: 'Cancel', onClick: function (ev) {
    ...
    var PickerCustomResultExample = (function (_super) {
        ...
        PickerCustomResultExample.prototype.render = function () {
            return (React.createElement("div", null,
                React.createElement(Checkbox_1.Checkbox, { label: 'Disable Document Picker', checked: this.state.isPickerDisabled, onChange: this._onDisabledButtonClick.bind(this) }),
                React.createElement(DocumentPicker, { onRenderSuggestionsItem: exports.SuggestedBigItem, onResolveSuggestions: this._onFilterChanged, onRenderItem: exports.SelectedDocumentItem, getTextFromItem: function (props) { return props.documentTitleProps.title; }, pickerSuggestionsProps: {
        ...
        PickerCustomResultExample.prototype._onDisabledButtonClick = function () {
            this.setState({
        ...
        PickerCustomResultExample.prototype._onFilterChanged = function (filterText, items) {
            var _this = this;
            return filterText ? data.filter(function (item) { return item.documentTitleProps && item.documentTitleProps.title.toLowerCase().indexOf(filterText.toLowerCase()) === 0; }).filter(function (item) { return !_this._listContainsDocument(item, items); }) : [];
        };
