define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./examples/Nav.Basic.Example", "./examples/Nav.FabricDemoApp.Example", "./examples/Nav.Nested.Example", "./examples/Nav.ByKeys.Example"], function (require, exports, tslib_1, React, example_app_base_1, Nav_Basic_Example_1, Nav_FabricDemoApp_Example_1, Nav_Nested_Example_1, Nav_ByKeys_Example_1) {
    "use strict";
