    ...
    var ScrollablePanePage = (function (_super) {
        ...
        ScrollablePanePage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'ScrollablePane', componentName: 'ScrollablePaneExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement("p", null, "ScrollablePane is a helper component designed to use in conjunction with a Sticky component.  ScrollablePane will find the nearest scrollable parent element, and designate that as the container for Sticky components.  Sticky components will \"stick\" to the top or bottom of a ScrollablePane's scrollable region and remain visible.")), bestPractices: React.createElement("div", null), dos: React.createElement("div", null,
                    React.createElement("ul", null,
                        React.createElement("li", null, "Designate the nearest scrollable parent with the attribute data-is-scrollable=true"),
