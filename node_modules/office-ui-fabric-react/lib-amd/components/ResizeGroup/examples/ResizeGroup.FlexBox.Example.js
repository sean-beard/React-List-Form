define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Utilities", "office-ui-fabric-react/lib/Styling", "office-ui-fabric-react/lib/ResizeGroup"], function (require, exports, tslib_1, React, Utilities_1, Styling_1, ResizeGroup_1) {
    ...
    function onReduceData(props) {
        ...
        if (props.leftCount > props.rightCount) {
            result = tslib_1.__assign({}, props, { leftCount: props.leftCount - 1 });
        }
        else {
            result = tslib_1.__assign({}, props, { rightCount: props.rightCount - 1 });
        }
        // Update the cache key
        return tslib_1.__assign({}, result, { cacheKey: "" + (result.leftCount + result.rightCount) });
    }
    var FlexBoxResizeGroupExample = (function (_super) {
        tslib_1.__extends(FlexBoxResizeGroupExample, _super);
        function FlexBoxResizeGroupExample() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        FlexBoxResizeGroupExample.prototype.render = function () {
            var data = { leftCount: 5, rightCount: 5, cacheKey: '10' };
            return (React.createElement(ResizeGroup_1.ResizeGroup, { data: data, onRenderData: function (scaledData) { return React.createElement(LeftRightBoxSet, tslib_1.__assign({}, scaledData)); }, onReduceData: onReduceData }));
        };
        return FlexBoxResizeGroupExample;
    }(Utilities_1.BaseComponent));
    exports.FlexBoxResizeGroupExample = FlexBoxResizeGroupExample;
});
