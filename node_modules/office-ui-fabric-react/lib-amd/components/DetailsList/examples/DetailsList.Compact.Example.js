define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/TextField", "office-ui-fabric-react/lib/DetailsList", "office-ui-fabric-react/lib/MarqueeSelection"], function (require, exports, tslib_1, React, TextField_1, DetailsList_1, MarqueeSelection_1) {
    "use strict";
        ...
        DetailsListCompactExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                ...
                React.createElement(MarqueeSelection_1.MarqueeSelection, { selection: this._selection },
                    React.createElement(DetailsList_1.DetailsList, { items: items, columns: _columns, setKey: 'set', layoutMode: DetailsList_1.DetailsListLayoutMode.fixedColumns, selection: this._selection, selectionPreservedOnEmptyClick: true, onItemInvoked: function (item) { return alert("Item invoked: " + item.name); }, compact: true }))));
        };
