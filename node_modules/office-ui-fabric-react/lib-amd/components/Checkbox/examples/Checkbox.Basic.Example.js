define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Checkbox", "office-ui-fabric-react/lib/Persona"], function (require, exports, tslib_1, React, Checkbox_1, Persona_1) {
    "use strict";
    ...
    var CheckboxBasicExample = (function (_super) {
        ...
        CheckboxBasicExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                ...
                React.createElement(Checkbox_1.Checkbox, { label: 'Controlled checkbox', checked: isChecked, onChange: function (ev, checked) {
        ...
        CheckboxBasicExample.prototype._renderPersonaLabel = function (props) {
            var DEFAULT_IMAGE_URL = '/_layouts/15/userphoto.aspx?size=S&accountname=';
            return React.createElement(Persona_1.Persona, { primaryText: props.label, imageUrl: DEFAULT_IMAGE_URL, size: Persona_1.PersonaSize.extraSmall });
        };
