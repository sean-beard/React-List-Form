define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Link", "@uifabric/example-app-base", "./examples/FocusTrapZone.Box.Example", "./examples/FocusTrapZone.Box.FocusOnCustomElement.Example", "./examples/FocusTrapZone.Box.Click.Example", "./examples/FocusTrapZone.Nested.Example"], function (require, exports, tslib_1, React, Link_1, example_app_base_1, FocusTrapZone_Box_Example_1, FocusTrapZone_Box_FocusOnCustomElement_Example_1, FocusTrapZone_Box_Click_Example_1, FocusTrapZone_Nested_Example_1) {
    "use strict";
    ...
    var FocusTrapZonePage = (function (_super) {
        tslib_1.__extends(FocusTrapZonePage, _super);
