define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./examples/Panel.SmallRight.Example", "./examples/Panel.SmallLeft.Example", "./examples/Panel.SmallFluid.Example", "./examples/Panel.Medium.Example", "./examples/Panel.Large.Example", "./examples/Panel.LargeFixed.Example", "./examples/Panel.ExtraLarge.Example", "./examples/Panel.Custom.Example", "./examples/Panel.LightDismiss.Example", "./examples/Panel.NonModal.Example", "./examples/Panel.Footer.Example", "../../Styling"], function (require, exports, tslib_1, React, example_app_base_1, Panel_SmallRight_Example_1, Panel_SmallLeft_Example_1, Panel_SmallFluid_Example_1, Panel_Medium_Example_1, Panel_Large_Example_1, Panel_LargeFixed_Example_1, Panel_ExtraLarge_Example_1, Panel_Custom_Example_1, Panel_LightDismiss_Example_1, Panel_NonModal_Example_1, Panel_Footer_Example_1, Styling_1) {
    "use strict";
    ...
    var PanelPage = (function (_super) {
        ...
        PanelPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'Panel', componentName: 'PanelExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Panel - Footer', code: PanelFooterExampleCode },
                        React.createElement(Panel_Footer_Example_1.PanelFooterExample, null))), propertiesTables: React.createElement(example_app_base_1.PropertiesTableSet, { sources: [
                    ...
                    React.createElement("h2", { className: Styling_1.FontClassNames.xLarge }, "Examples of experiences that use Panels"),
                    ...
                    React.createElement("ul", null,
                        React.createElement("li", null, "Use for experiences where the user needs to interact with the app view."))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/Panel/Panel.html' }, "Fabric JS"), isHeaderVisible: this.props.isHeaderVisible }));
        };
        return PanelPage;
    }(React.Component));
